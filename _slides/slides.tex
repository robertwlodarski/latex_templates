...
\subtitle{An oven-ready template}
\date{\today}
...
The standard enumeration and itemization approaches:
\begin{enumerate}
...
\begin{itemize}
  \item \texttt{itemize}
\end{itemize}
My own approaches, only to be used in the \enquote{sub} environment:
\begin{itemize_arrow}
  \item \texttt{itemize$\_$arrow}
\end{itemize_arrow}
...
%     \item Pretty good
%     \newline
%     \citecolor{\citet{Fajgelbaum_Morales_Serrato_Zidar_2018}}
    
%     \item To include things in appendix
%   \end{enumerate}

%   \begin{itemize}
%     \item Check if they align. 
%   \end{itemize}
% \end{frame}
...
% \begin{frame}{Equations}{Trying my own stuff}
%     \begin{equation}
%       V \bp{ \frac{s}{1+r} }
%     \end{equation}
% \end{frame}
